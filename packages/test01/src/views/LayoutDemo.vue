<template>
  <div class="layout" :style="style">
    <header class="header" :style="layoutHeader">header {{ sx }} -- {{ sy }}</header>
    <div id="tab" class="tab" :style="layoutTab">tab</div>
    <aside class="asidel" :style="layoutAsideL">aside left</aside>
    <main class="main" :style="layoutMain">
      <ul id="example-2">
        <li v-for="n in 150">adfsafd {{ n }} {{ x }} {{ y }} {{ mainh }}<br /></li>
        <zxx-scroll>
          <p>
