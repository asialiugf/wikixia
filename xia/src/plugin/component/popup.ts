...
export default class Popup {
  ...
  onSelect = () => {
    ...
    this.showContent(() => {
      ...
      let top = this.#align === 'top' ? targetRect.top - rootRect.height - space : targetRect.bottom + space;
      if (this.#editor.scrollNode) {
        const scrollNodeRect = this.#editor.scrollNode.get<HTMLElement>()?.getBoundingClientRect();
        if (scrollNodeRect) {
